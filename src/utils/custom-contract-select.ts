...
export const generateContractSelectOptions = (network: string) => {
  if (network === "mainnet") {
    return [
      ...
      { value: "Insert Contract Address", label: "Add Contract Address" },
    ];
    ...
    return [{ value: "Insert Contract Address", label: "Add Contract Address" }];
  }
};
...
export const contractSelectStyles = {
  singleValue: (provided: any, state: any) => {
    const color = state.data.label === "Add Contract Address" ? "#aaa !important" : "#333 !important";
